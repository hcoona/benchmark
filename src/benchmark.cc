...
DEFINE_string(
    ...
    "'false'/'no'/0, and 'auto'. 'auto' means to use colors if the output is "
    "being sent to a terminal and the TERM environment variable is set to a "
    "terminal type that supports colors.");
